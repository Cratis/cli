...
/// </summary>
[LlmDescription("Shows detailed failure information for a specific observer partition including the full exception stack trace, failed sequence number, and retry count. Use -o json-compact.")]
