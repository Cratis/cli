...
/// </summary>
[LlmDescription("Replays an observer from the beginning of the event log, resetting all state it has built. Destructive — prompts for confirmation unless --yes is specified.")]
