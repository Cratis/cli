...
public class when_publishing_over_an_unmanaged_file : given.an_artifact_publication
{
    ...
    [Fact] void should_not_publish_a_manifest() => File.Exists(ArtifactPublicationStorage.ManifestPath(_destination)).ShouldBeFalse();
}
