...
public class and_the_command_asks_before_changing_local_configuration : given.a_command_catalog
{
    JsonObject _command;

    void Because() => _command = CommandAt(LlmContextCommand.BuildDescriptorJson(), "context delete");
