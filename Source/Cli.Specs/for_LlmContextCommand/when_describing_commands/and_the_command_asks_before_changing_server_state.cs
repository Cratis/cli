...
public class and_the_command_asks_before_changing_server_state : given.a_command_catalog
{
    JsonObject _command;

    void Because() => _command = CommandAt(LlmContextCommand.BuildDescriptorJson(), "chronicle jobs stop");
