...
using context = Cratis.Cli.Integration.Chronicle.for_EventStores.when_listing_event_stores.context;

namespace Cratis.Cli.Integration.Chronicle.for_EventStores;
