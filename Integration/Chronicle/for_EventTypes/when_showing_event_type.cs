...
using context = Cratis.Cli.Integration.Chronicle.for_EventTypes.when_showing_event_type.context;

namespace Cratis.Cli.Integration.Chronicle.for_EventTypes;
