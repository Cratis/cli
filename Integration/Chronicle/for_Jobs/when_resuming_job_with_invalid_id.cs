...
using context = Cratis.Cli.Integration.Chronicle.for_Jobs.when_resuming_job_with_invalid_id.context;

namespace Cratis.Cli.Integration.Chronicle.for_Jobs;

[Collection(ChronicleCollection.Name)]
public class when_resuming_job_with_invalid_id(context context) : CliGiven<context>(context)
{
